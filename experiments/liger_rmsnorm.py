#!/usr/bin/env python3
"""Liger RMSNorm vs HF reference, bf16. Auto-detects arch at runtime.

This file is the recommended day-to-day iteration unit. Edit it, dispatch
via the SDK, and the new code runs in the next pod with no image rebuild
required (the image bakes swordfish + liger; rune's --script base64-encodes
this file into the pod).

Run via the Python SDK:
...
def main() -> int:
    ...
    out_path = data_dir / "swordfish" / "week1" / "liger-perkernel" / f"rmsnorm-{arch}.json"
